...
(
   ...
   location VARCHAR (60) COLLATE latin1_bin NOT NULL,
   email VARCHAR (60) COLLATE latin1_bin NOT NULL,
   allergies VARCHAR (1000) COLLATE latin1_bin NOT NULL,
   diseases VARCHAR (1000) COLLATE latin1_bin NOT NULL,
   interventions VARCHAR (1000) COLLATE latin1_bin NOT NULL,
   family_background VARCHAR (1000) COLLATE latin1_bin NOT NULL,
   smoker TINYINT (4) DEFAULT NULL,
   menarche BIGINT NOT NULL,
   menopause BIGINT NOT NULL,
   last_menstruation_date DATETIME NOT NULL,
   discharge_date TIMESTAMP NOT NULL,
   pregnancies BIGINT NOT NULL,
   childbirths BIGINT NOT NULL,
   cesarean_sections BIGINT NOT NULL,
   misbirths BIGINT NOT NULL,
   menstrual_type VARCHAR (60) COLLATE latin1_bin NOT NULL,
   user_id BIGINT NOT NULL,
   enabled TINYINT (4) DEFAULT NULL,
